...
class AnalyticTest extends TestCase
{
    ...
    /**
     * PHPUnit test: vendor/bin/phpunit --filter testLogGameTransaction tests/AnalyticTest.php
     */
    ...
    /**
     * PHPUnit test: vendor/bin/phpunit --filter testLogGameCardTransaction tests/AnalyticTest.php
     */
    ...
    /**
     * PHPUnit test: vendor/bin/phpunit --filter testLogMobileCardTransaction tests/AnalyticTest.php
     */
    ...
    /**
     * PHPUnit test: vendor/bin/phpunit --filter testLogMobileNetworkTransaction tests/AnalyticTest.php
     */
    ...
    /**
     * PHPUnit test: vendor/bin/phpunit --filter testLogTopupMobileTransaction tests/AnalyticTest.php
     */
